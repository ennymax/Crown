...
public class AddNewUser extends TestBase {
    ...
    public void ADD_NEW_USERS() throws IOException, InterruptedException {
        ...
        driver.findElement(By.xpath(Utility.fetchLocator("NewUserEmail1_XPATH"))).sendKeys(ramdomword.ListRandom() + ramdomwords.ListRandom()+"@gmail.com");
        ...
        Thread.sleep(2000);
        if (driver.findElements(By.xpath(Utility.fetchLocator("AssertNewUserCreation1_XPATH"))).size() != 0) {
