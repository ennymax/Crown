...
public class Set_Minimum_Order_and_Assert_Minimum_Order extends TestBase {
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Test(priority = 8)
    public void SetminimumOrder() throws IOException, InterruptedException {
        javaScriptUtil.DoscrolltoViewClickWhenReady(driver, "setminimumOrderBTN_XPATH", "mii_TEXT", 60);
    }

    @Description("input minimum Order")
    @Severity(SeverityLevel.CRITICAL)
    @Test(priority = 9)
    public void inputminimumOrder() throws IOException, InterruptedException {
    ...
    @Description("Save minimum Order")
    @Severity(SeverityLevel.CRITICAL)
    @Test(priority = 10)
    public void SaveminimumOrder() throws IOException, InterruptedException {
    ...
    @Description("Reset Minimum Order")
    @Severity(SeverityLevel.CRITICAL)
    @Test(priority = 25)
