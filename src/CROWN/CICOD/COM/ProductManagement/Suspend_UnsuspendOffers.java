...
public class Suspend_UnsuspendOffers extends TestBase {
    ...
    public void Action() throws IOException, InterruptedException {
        ExcelUtil excelUtil = new ExcelUtil(driver);
        excelUtil.DoscrolltoViewClickWhenReady(driver,"OfferActionBTN_XPATH", 20);
    }
    ...
    public void Suspend() throws IOException, InterruptedException {
        ExcelUtil excelUtil = new ExcelUtil(driver);
        excelUtil.DoscrolltoViewClickWhenReady(driver,"SuspendOfferbtn_XPATH", 20);
    }
    ...
    public void AssertSuspend() throws IOException, InterruptedException {
        ...
        assertion.DoAssertContainsWhenReady(driver,"aSS_XPATH","Offers_TEXT","OffersPass_TEXT","OffersFail_TEXT",20);
    }
    ...
    public void Unsuspend() throws IOException, InterruptedException {
        ExcelUtil excelUtil = new ExcelUtil(driver);
        excelUtil.DoscrolltoViewClickWhenReady(driver,"UnsuspendOffer_XPATH", 20);
    }
    ...
    public void AssertUnSuspend() throws IOException, InterruptedException {
        Assertion assertion = new Assertion(driver);
        assertion.DoAssertContainsWhenReady(driver,"aSS_XPATH","Offers1_TEXT","OffersPass1_TEXT","OffersFail1_TEXT",20);
    }
}
